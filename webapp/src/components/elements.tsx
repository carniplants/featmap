...
export const Button: FunctionComponent<{ iconColor?: string, title?: string, small?: boolean, button?: boolean, secondary?: boolean, icon?: string, handleOnClick?: () => void, warning?: boolean, primary?: boolean, submit?: boolean, noborder?: boolean }> = (props) => (
...
export const DarkButton: FunctionComponent<{ submit?: boolean, primary?: boolean, children?: React.ReactNode, handleOnClick?: () => void }> = (props) => (
...
export const CardLayout: FunctionComponent<{ title?: string, children?: React.ReactNode }> = props => {
    return (
